...
| `visimark ref [NAME]` | Prints what a builtin function does — signature, parameters, errors, worked examples — or lists all fifteen | `--json` | nothing | `0` · `2` no such function |
