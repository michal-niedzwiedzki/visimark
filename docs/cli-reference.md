...
| `visimark ref [NAME]` | Prints the reference entry for a builtin function, or lists all fourteen | nothing — the only command that reads no file | nothing | `NAME` is not a builtin function |
